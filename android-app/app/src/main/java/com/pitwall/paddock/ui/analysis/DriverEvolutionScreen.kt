...
@Composable
fun DriverEvolutionScreen(sessions: List<SessionSummary>) {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .background(ColorInk)
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            PitwallTopBar(title = "DRIVER EVOLUTION")
            ...
            Box(
                ...
                Text(
                    text = "Driver Evolution tracking coming soon. \nFound ${sessions.size} sessions.",
                    color = ColorSlate,
