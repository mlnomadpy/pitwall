...
from pitwall.features.coaching.lstm_predictor_v3 import (
...
class SonicModelV2:
    ...
    def _corner_tracking(self, frame):
        ...
        from pitwall.features.track.track_loader import is_in_corner
        ...
        if not corner and self.in_corner_name:
            ...
            from pitwall.features.track.track_loader import find_nearest_corner
